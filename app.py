...
######################
if selected == 'Home':
    st.title('BMI App Prediction')
    st.markdown("""
    This app contains 3 sections which you can acces from the horizontal menu above.
    The sections are:
...
if selected == 'Case 1':
    ...
    if predict_button:
        ...
        pred_multi = pd.concat([pd.DataFrame({'BMI Value' : [user_input['bmi_pre'].values[0]]}),
                                pred_multi] , axis = 0)
        pred_multi['Lower Diference'] = pd.DataFrame(diferences_down[0:] , index = pred_multi.index.tolist())
        pred_multi['Upper Diference'] = pd.DataFrame(diferences_up[0:] , index = pred_multi.index.tolist())
...
if selected == 'Case 2':
    ...
    if multi_select_list[0] in multiselect_bmi_future:
        bmi_6_months = st.sidebar.number_input("Please enter bmi 6 months value:")
    ...
    if multi_select_list[1] in multiselect_bmi_future:
        bmi_12_months = st.sidebar.number_input("Please enter bmi 12 months value:")
    ...
    if multi_select_list[2] in multiselect_bmi_future:
        bmi_18_months = st.sidebar.number_input("Please enter bmi 18 months value:")
        multi_select_list_2.append('bmi_12_months')
    if multi_select_list[2] not in multiselect_bmi_future:
        bmi_18_months = -1
    if multi_select_list[3] in multiselect_bmi_future:
        bmi_2_years = st.sidebar.number_input("Please enter bmi 2 years value:")
    ...
    if multi_select_list[4] in multiselect_bmi_future:
        bmi_3_years = st.sidebar.number_input("Please enter bmi 3 years value:")
    ...
    if multi_select_list[5] in multiselect_bmi_future:
        bmi_4_years = st.sidebar.number_input("Please enter bmi 4 years value:")
    ...
    if multi_select_list[6] in multiselect_bmi_future:
        bmi_5_years = st.sidebar.number_input("Please enter bmi 5 years value:")
    ...
    if predict_button:
        ...
        if ((user_input['bmi_12_months'].values[0] != 0) or (user_input['bmi_18_months'].values[0] != 0) or (user_input['bmi_2years'].values[0] != 0) or (user_input['bmi_3years'].values[0] != 0) or (user_input['bmi_4years'].values[0] != 0) or (user_input['bmi_5years'].values[0] != 0)) and user_input['bmi_6_months'].values[0] == 0:
            st.warning('The value of BMI 6 months is 0 and you put information on further BMI timesteps, check the input', icon="⚠️")
            number_of_warnings += 1
        ...
        if ((user_input['bmi_18_months'].values[0] != 0) or (user_input['bmi_2years'].values[0] != 0) or (user_input['bmi_3years'].values[0] != 0) or (user_input['bmi_4years'].values[0] != 0) or (user_input['bmi_5years'].values[0] != 0)) and user_input['bmi_12_months'].values[0] == 0:
            st.warning('The value of BMI 12 months is 0 and you put information on further BMI timesteps, check the input', icon="⚠️")
            number_of_warnings += 1
        ...
        if ((user_input['bmi_2years'].values[0] != 0) or (user_input['bmi_3years'].values[0] != 0) or (user_input['bmi_4years'].values[0] != 0) or (user_input['bmi_5years'].values[0] != 0)) and user_input['bmi_18_months'].values[0] == 0:
            st.warning('The value of BMI 18 months is 0 and you put information on further BMI timesteps, check the input', icon="⚠️")
            number_of_warnings += 1
        ...
        if ((user_input['bmi_3years'].values[0] != 0) or (user_input['bmi_4years'].values[0] != 0) or (user_input['bmi_5years'].values[0] != 0)) and user_input['bmi_2years'].values[0] == 0:
            st.warning('The value of BMI 2 years is 0 and you put information on further BMI timesteps, check the input', icon="⚠️")
            number_of_warnings += 1
        ...
        if ((user_input['bmi_4years'].values[0] != 0) or (user_input['bmi_5years'].values[0] != 0)) and user_input['bmi_3years'].values[0] == 0:
            st.warning('The value of BMI 3 years is 0 and you put information on further BMI timesteps, check the input', icon="⚠️")
            number_of_warnings += 1
        # Check for bmi 4 years
        if ((user_input['bmi_5years'].values[0] != 0)) and user_input['bmi_4years'].values[0] == 0:
            st.warning('The value of BMI 4 years is 0 and you put information on further BMI timesteps, check the input', icon="⚠️")
            number_of_warnings += 1
        if number_of_warnings == 0: # Perform prediction only if there is no warning
            ...
            real_bmi['Lower Diference'] = [0 if i in real_bmi_columns else diferences_down[bmi_columns.index(i)] for i in real_bmi.index.tolist()]
            real_bmi['Upper Diference'] = [0 if i in real_bmi_columns else diferences_up[bmi_columns.index(i)] for i in real_bmi.index.tolist()]
            real_bmi['Lower Bound'] = real_bmi['BMI Value'] + real_bmi['Lower Diference']
            real_bmi['Upper Bound'] = real_bmi['BMI Value'] + real_bmi['Upper Diference']
            real_bmi = real_bmi.drop(columns = ['Lower Diference' , 'Upper Diference'])
            # Create the plot
            ...
            pred_multi['Lower Diference'] = [0 if i in real_bmi_columns else diferences_down[bmi_columns.index(i)] for i in pred_multi.index.tolist()]
            pred_multi['Upper Diference'] = [0 if i in real_bmi_columns else diferences_up[bmi_columns.index(i)] for i in pred_multi.index.tolist()]
            pred_multi['Lower Bound'] = pred_multi['BMI Value'] + pred_multi['Lower Diference']
            pred_multi['Upper Bound'] = pred_multi['BMI Value'] + pred_multi['Upper Diference']
            pred_multi = pred_multi.drop(columns = ['Lower Diference' , 'Upper Diference'])
            # Create the plot
