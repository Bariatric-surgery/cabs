...
def initialize_app():
    ...
    model_case_1 = pkl.load(open(r'models/MLP_Option_3.sav' , 'rb'))
    ...
    return model_single, model_multioutput, data, bmi_columns, diferences_down, diferences_up, model_case_1
###############################################################################
...
# Initialize app
model_single, model_multioutput, data, bmi_columns, diferences_down, diferences_up, model_case_1 = initialize_app()
...
if selected == 'Case 1':
    ...
    if predict_button:
        ...
        if number_of_warnings == 0:
            ...
            pred_multi = pd.DataFrame(model_case_1.predict(user_input.drop(columns = ['BMI(t)'])) , columns = bmi_columns).T
...
if selected == 'Case 2':
    ...
    if multi_select_list[0] in multiselect_bmi_future:
        bmi_6_months = st.slider("BMI 6 months value:" , min_value = 35.0, max_value = 100.0, step = 0.1)
    ...
    if multi_select_list[1] in multiselect_bmi_future:
        bmi_12_months = st.slider("BMI 12 months value:" , min_value = 35.0, max_value = 100.0, step = 0.1)
    ...
    if multi_select_list[2] in multiselect_bmi_future:
        bmi_18_months = st.slider("BMI 18 months value:" , min_value = 35.0, max_value = 100.0, step = 0.1)
    ...
    if multi_select_list[3] in multiselect_bmi_future:
        bmi_2_years = st.slider("BMI 2 years value:" , min_value = 35.0, max_value = 100.0, step = 0.1)
    ...
    if multi_select_list[4] in multiselect_bmi_future:
        bmi_3_years = st.slider("BMI 3 years value:" , min_value = 35.0, max_value = 100.0, step = 0.1)
    ...
    if multi_select_list[5] in multiselect_bmi_future:
        bmi_4_years = st.slider("BMI 4 years value:" , min_value = 35.0, max_value = 100.0, step = 0.1)
    ...
    if multi_select_list[6] in multiselect_bmi_future:
        bmi_5_years = st.slider("BMI 5 years value:" , min_value = 35.0, max_value = 100.0, step = 0.1)
